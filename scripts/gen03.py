#!/usr/bin/env python3
"""Generate example03_chernobyl.ipynb via json.dump()."""

import json
import os

NOTEBOOK_PATH = "/home/z/my-project/soilactivity/examples/example03_chernobyl.ipynb"
...
def build_notebook():
    ...
    # ===== Section 5: Spatial Distribution Maps =====
    cells.append(md([
