#!/usr/bin/env python3
"""Generate example04_semei.ipynb via json.dump()."""

import json
import os

NOTEBOOK_PATH = "/home/z/my-project/soilactivity/examples/example04_semei.ipynb"
...
def build_notebook():
    ...
    cells.append(code([
        ...
        "\n",
        "fig.tight_layout()\n",
        "fig.savefig('/home/z/my-project/soilactivity/examples/fig_semei_geography.png',\n",
        "            bbox_inches='tight', dpi=120)\n",
        "print('Saved fig_semei_geography.png')\n",
        "plt.close(fig)\n",
    ]))

    # ===== Section 4: Contamination Model =====
    cells.append(md([
    ...
    cells.append(code([
        ...
        "\n",
        "fig.tight_layout()\n",
        "fig.savefig('/home/z/my-project/soilactivity/examples/fig_semei_maps.png',\n",
        "            bbox_inches='tight', dpi=120)\n",
        "print('Saved fig_semei_maps.png')\n",
        "plt.close(fig)\n",
    ]))

    # ===== Section 6: Dose Rate from Cs-137 =====
    cells.append(md([
    ...
    cells.append(code([
        ...
        "\n",
        "fig.tight_layout()\n",
        "fig.savefig('/home/z/my-project/soilactivity/examples/fig_semei_dose.png',\n",
        "            bbox_inches='tight', dpi=120)\n",
        "print('Saved fig_semei_dose.png')\n",
        "plt.close(fig)\n",
    ]))

    # ===== Section 7: Fredholm SAD Reconstruction =====
    cells.append(md([
    ...
    cells.append(code([
        ...
        "\n",
        "fig.tight_layout()\n",
        "fig.savefig('/home/z/my-project/soilactivity/examples/fig_semei_fredholm.png',\n",
        "            bbox_inches='tight', dpi=120)\n",
        "print('Saved fig_semei_fredholm.png')\n",
        "plt.close(fig)\n",
    ]))

    # ===== Section 8: Comparison Cs-137 vs Sr-90 =====
    cells.append(md([
    ...
    cells.append(code([
        ...
        "\n",
        "fig.tight_layout()\n",
        "fig.savefig('/home/z/my-project/soilactivity/examples/fig_semei_comparison.png',\n",
        "            bbox_inches='tight', dpi=120)\n",
        "print('Saved fig_semei_comparison.png')\n",
        "plt.close(fig)\n",
    ]))

    # ===== Section 9: Lorenz Curves by Test Site =====
    cells.append(md([
    ...
    cells.append(code([
        ...
        "\n",
        "fig.tight_layout()\n",
        "fig.savefig('/home/z/my-project/soilactivity/examples/fig_semei_lorenz.png',\n",
        "            bbox_inches='tight', dpi=120)\n",
        "print('Saved fig_semei_lorenz.png')\n",
        "plt.close(fig)\n",
    ]))

    # ===== Section 10: Village Dose Reconstruction =====
    cells.append(md([
    ...
    cells.append(code([
        ...
        "ax.set_title('Estimated Annual Dose for Modelled Villages (8760 h outdoor)\n",
        "             ' - Cs-137 contribution only', fontsize=11)\n",
        "ax.legend(fontsize=10)\n",
        "ax.set_yscale('log')\n",
        "ax.set_ylim(bottom=0.001)\n",
        "\n",
        "fig.tight_layout()\n",
        "fig.savefig('/home/z/my-project/soilactivity/examples/fig_semei_villages.png',\n",
        "            bbox_inches='tight', dpi=120)\n",
